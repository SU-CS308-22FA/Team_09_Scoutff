  ...
  export default function SquareClickable() {
    ...
    return (
      ...
      <Flex h='550px' marginTop='50px' marginLeft='60px' marginRight='60px' padding='30px' rounded='20'>
            <Button onClick={() => router.push('/squads')} sx={{ borderRadius: "2%" }} h='200px' alignSelf='center' margin='100px' flex='1' color='black' bg='blue.600' fontFamily='cursive' fontSize='18px'>Expert's Squad</Button>
