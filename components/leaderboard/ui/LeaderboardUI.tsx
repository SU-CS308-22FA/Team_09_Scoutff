...
export default function LeaderboardUI() {
  return (
    ...
    <Flex color='white' h='500px' marginTop='50px' marginLeft='60px' marginRight='60px' padding='30px' rounded='20'>


      <Box  w='100px' flex='1' bg='blue.600' sx={{ borderRadius: "10%" }} >
        <Center margin='20px' color='black' fontFamily='cursive' fontSize='18px'>Top Ratings</Center>
        <Divider color='gray.300'></Divider>
      </Box>
      <Box  w='100px' flex='1' bg='blue.600' marginX='40px' sx={{ borderRadius: "10%" }}>
